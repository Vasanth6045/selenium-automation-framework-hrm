...
public class TC_INT_01 extends BaseClass {
	...
	public void leaveRequest() throws IOException {
		...
		Assert.assertTrue(mlrp.getMyLeaveRequestHedder().getText().contains("My Leave Requests"),
				"my leave request page not displayed");
		...
		Assert.assertTrue(lrp.getLeaveDetailsHedder().getText().contains("Hittler"),
				"leave requests not visible for HR");
